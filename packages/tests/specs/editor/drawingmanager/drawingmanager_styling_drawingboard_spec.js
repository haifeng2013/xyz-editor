...
describe('Styling drawingboard', function() {
    ...
    it('add shape point and validate default style of drawingboard', async function() {
        ...
        await new Promise((resolve) => {
            setTimeout(() => {
                let color1 = testUtils.getCanvasPixelColor(mapContainer, 100, 100);
                let color2 = testUtils.getCanvasPixelColor(mapContainer, 100, 200);
